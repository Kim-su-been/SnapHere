...
public class UserDevice {
 ...
 protected UserDevice(){} public static UserDevice create(User u,String identifier,Platform platform,String fcm){ UserDevice d=new UserDevice();d.id=UUID.randomUUID();d.user=u;d.deviceIdentifier=identifier;d.platform=platform;d.fcmToken=fcm;d.updatedAt=Instant.now();return d; }
